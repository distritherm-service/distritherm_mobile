...
export const ICON_SIZE = IS_TABLET ? ms(30) : ms(24);
export const FLOATING_BUTTON_SIZE = IS_TABLET ? ms(46) : ms(32);
...
export const TAB_LABEL_FONT_SIZE = IS_TABLET ? ms(11) : ms(9);
export const FLOATING_BUTTON_ICON_SIZE = IS_TABLET ? ms(28) : ms(21);
