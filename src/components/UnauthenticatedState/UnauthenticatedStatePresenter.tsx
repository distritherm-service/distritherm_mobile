...
import { UnauthenticatedStateProps } from "./UnauthenticatedState";

const UnauthenticatedStatePresenter: React.FC<UnauthenticatedStateProps> = ({
  icon,
  title,
  description,
  ...
  const dynamicStyles = StyleSheet.create({
    ...
    iconContainer: {
      backgroundColor: colors[iconColor][50],
      width: ms(80),
      height: ms(80),
      borderRadius: ms(40),
      justifyContent: "center",
...
export default UnauthenticatedStatePresenter; 