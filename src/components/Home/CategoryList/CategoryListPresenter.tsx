...
const CategoryListPresenter: React.FC<CategoryListPresenterProps> = ({
  ...
  const renderCategoryItem = ({ item }: { item: Category }) => (
    ...
    >
      <View style={dynamicStyles.imageContainer}>
        ...
        />
        {item.haveChildren && <View style={dynamicStyles.childrenIndicator} />}
      </View>
  ...
  const renderEmptyState = () => (
    <View style={dynamicStyles.emptyStateContainer}>
      <Text style={dynamicStyles.emptyStateText}>Aucune catégorie disponible</Text>
    </View>
  );
    ...
    if (error) {
      return (
        <View style={dynamicStyles.errorContainer}>
          <Text style={dynamicStyles.errorText}>Erreur de chargement</Text>
