...
const DevisCardPresenter: React.FC<DevisCardPresenterProps> = ({
  ...
  const dynamicStyles = {
    card: {
      ...
      borderRadius: ms(20), // More rounded for modern look
      padding: s(20),
      marginBottom: vs(16),
      ...
      shadowRadius: 12,
      elevation: 6,
      borderLeftWidth: 5, // Slightly thicker accent
    ...
    <View style={dynamicStyles.card}>
      ...
      <View style={dynamicStyles.header}>
        <View style={dynamicStyles.numberContainer}>
          <Text style={dynamicStyles.devisNumber}>Devis #{devis.id}</Text>
          <Text style={dynamicStyles.devisId}>ID: {devis.id.toString().padStart(6, '0')}</Text>
        </View>
      ...
      <View style={dynamicStyles.actionsContainer}>
        ...
        <TouchableOpacity
          style={[
            ...
            isDownloadDisabled && dynamicStyles.downloadButtonDisabled,
          ]}
          onPress={onDownload}
          disabled={isDownloadDisabled}
          activeOpacity={isDownloadDisabled ? 1 : 0.8}
        >
          {isDownloading ? (
